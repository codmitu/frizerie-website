            ...
            <Container>
                ...
                <AboutContainer>
                    <AboutWrapper>
                        ...
                        <FormContainer />
                        <Schedule />
                        <MapAddress><div className="gmap_canvas"><iframe title="map" width="100%" height="293" id="gmap_canvas" src="https://maps.google.com/maps?q=Bucharest%20frizerie&t=&z=17&ie=UTF8&iwloc=&output=embed" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0"></iframe><br /></div>
                        </MapAddress>
                    </AboutWrapper>
                </AboutContainer>
            </Container>
